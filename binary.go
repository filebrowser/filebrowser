...
func templatesBaseTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/base.tmpl", size: 2787, mode: os.FileMode(438), modTime: time.Unix(1466625777, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
