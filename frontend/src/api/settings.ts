...
export interface ConvertXTestResponse {
  status: string;
  message: string;
}
...
export async function testConvertX(config: SettingsConvertX) {
  return fetchJSON<ConvertXTestResponse>(`/api/settings/convertx/test`, {
    method: "POST",
